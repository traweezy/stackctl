...
integration_regex="${STACKCTL_INTEGRATION_SMOKE_REGEX:-TestSetupNonInteractiveManagedLifecycleSmoke|TestManagedStackStartFailsFastWhenHostPortBusy|TestExternalStackMetadataSmoke|TestNamedStackSelectionAndPathResolution|TestNamedStackSingleRunningStackGuard}"
